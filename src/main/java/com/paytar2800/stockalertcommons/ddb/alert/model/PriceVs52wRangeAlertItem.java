...
import static com.paytar2800.stockalertcommons.ddb.alert.AlertDDBConstants.ALERT_PRICE_VS_50D_AVG_ALERT_PARAM;
import static com.paytar2800.stockalertcommons.ddb.alert.AlertDDBConstants.ALERT_PRICE_VS_52W_ALERT_PARAM;
...
@Data
@DynamoDBDocument
public class PriceVs52wRangeAlertItem implements IAlertDBItem {
    ...
    public String getDBKeyName() {
        return ALERT_PRICE_VS_52W_ALERT_PARAM;
    }
