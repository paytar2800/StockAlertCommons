...
public class APIParamConstants {
    ...
    public static final String API_PRICE_LADDER_ALERT_PARAM = "ladder";
    ...
    public static final String API_LADDER_STEP_PRICE_PARAM = "stepPrice";
    public static final String API_ACKNOWLEDGED_STEP_PARAM = "ackStep";
